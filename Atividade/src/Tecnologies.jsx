        ...
        <div className={style.wrapTec}>
            <h1 className={style.wraph1} >TECNOLOGIES </h1>
                ...
                <div className={style.wrapCardsTec}>
                    ...
                    <Card title='VITE' imgSrc={VITE} desc='O VITE é uma ferramenta de construção de aplicativos web que oferece uma alternativa mais rápida aos tradicionais sistemas de construção.'/>
                    ...
                    <Card title='NPM' imgSrc={NPM} desc='O NPM é um gerenciador de pacotes padrão para o ecossistema Node.js. Permite que os desenvolvedores instalem e gerenciem pacotes de software. '/>
